...
public class MasterDAO extends BaseHibernateDAO {
	...
	public Master findById(java.lang.Integer id) {
		...
		try {
			Master instance = (Master) getSession().get("com.jd.h.bean.Master",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Master> findByExample(Master instance) {
		...
		try {
			List<Master> results = (List<Master>) getSession()
					.createCriteria("com.jd.h.bean.Master")
	...
	public static void main(String[] args) {
		MasterDAO madao=new MasterDAO();
		Master ma=madao.findById(1);
		System.out.println(ma.getClasz());
	}
}